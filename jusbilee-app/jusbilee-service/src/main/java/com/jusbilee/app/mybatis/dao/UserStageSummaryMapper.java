...
public interface UserStageSummaryMapper {
    ...
    @Insert({
        ...
        "#{levelId,jdbcType=INTEGER}, #{songId,jdbcType=INTEGER}, ",
    ...
    @Select({
        "select",
        "id, user_id, stage_song_id, level_id, song_id, is_assist, assist_user_id, score, ",
        "is_passed, stage_count, create_time, update_time",
