...
public class UserPracticeUnlockLogSqlProvider {
    ...
    public String insertSelective(UserPracticeUnlockLog record) {
        ...
        if (record.getIsNeedLock() != null) {
            sql.VALUES("is_need_lock", "#{isNeedLock,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getIsNeedLock() != null) {
            sql.SET("is_need_lock = #{record.isNeedLock,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(UserPracticeUnlockLog record) {
        ...
        if (record.getIsNeedLock() != null) {
            sql.SET("is_need_lock = #{isNeedLock,jdbcType=INTEGER}");
        }
