...
import com.jusbilee.app.mybatis.pojo.RaceSeasonSongCriteria.Criteria;
import com.jusbilee.app.mybatis.pojo.RaceSeasonSongCriteria.Criterion;
import com.jusbilee.app.mybatis.pojo.RaceSeasonSongCriteria;
import java.util.List;
import java.util.Map;
import org.apache.ibatis.jdbc.SQL;

public class RaceSeasonSongSqlProvider {
     ...
     */
    public String countByExample(RaceSeasonSongCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_race_season_song");
     ...
     * @mbg.generated Wed Sep 14 07:56:40 CST 2016
     */
    public String deleteByExample(RaceSeasonSongCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("t_race_season_song");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Wed Sep 14 07:56:40 CST 2016
     */
    public String insertSelective(RaceSeasonSong record) {
        SQL sql = new SQL();
        sql.INSERT_INTO("t_race_season_song");
     ...
     * @mbg.generated Wed Sep 14 07:56:40 CST 2016
     */
    public String selectByExample(RaceSeasonSongCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        RaceSeasonSong record = (RaceSeasonSong) parameter.get("record");
        RaceSeasonSongCriteria example = (RaceSeasonSongCriteria) parameter.get("example");
        
        SQL sql = new SQL();
        sql.UPDATE("t_race_season_song");
     ...
     * @mbg.generated Wed Sep 14 07:56:40 CST 2016
     */
    public String updateByPrimaryKeySelective(RaceSeasonSong record) {
        SQL sql = new SQL();
        sql.UPDATE("t_race_season_song");
     ...
     * @mbg.generated Wed Sep 14 07:56:40 CST 2016
     */
    protected void applyWhere(SQL sql, RaceSeasonSongCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
