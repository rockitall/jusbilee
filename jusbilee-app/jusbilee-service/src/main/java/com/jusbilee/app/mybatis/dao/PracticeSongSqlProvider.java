...
public class PracticeSongSqlProvider {
    ...
    public String insertSelective(PracticeSong record) {
        ...
        if (record.getLockGoldCoin() != null) {
            sql.VALUES("lock_gold_coin", "#{lockGoldCoin,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getLockGoldCoin() != null) {
            sql.SET("lock_gold_coin = #{record.lockGoldCoin,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(PracticeSong record) {
        ...
        if (record.getLockGoldCoin() != null) {
            sql.SET("lock_gold_coin = #{lockGoldCoin,jdbcType=INTEGER}");
        }
