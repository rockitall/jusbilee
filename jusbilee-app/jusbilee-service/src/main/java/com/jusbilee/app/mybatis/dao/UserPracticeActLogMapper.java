...
public interface UserPracticeActLogMapper {
    ...
    @Insert({
        ...
        "full_score_best_time, is_deleted, ",
        ...
        "#{fullScoreBestTime,jdbcType=INTEGER}, #{isDeleted,jdbcType=TINYINT}, ",
    ...
    @Select({
        "select",
        "id, user_id, practice_song_id, total_practice_time, total_practice_count, total_practice_score, ",
        "best_avg_score, full_score_best_time, is_deleted, create_time, update_time",
