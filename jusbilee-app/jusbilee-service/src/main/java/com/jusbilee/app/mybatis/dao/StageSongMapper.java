...
public interface StageSongMapper {
     ...
     */
    @Insert({
        "insert into t_stage_song (song_id, pass_score, ",
        "level_id, start_time, ",
        "end_time, sort_order, ",
        "status, create_time, ",
        "update_time)",
        "values (#{songId,jdbcType=INTEGER}, #{passScore,jdbcType=INTEGER}, ",
        "#{levelId,jdbcType=INTEGER}, #{startTime,jdbcType=TIMESTAMP}, ",
        "#{endTime,jdbcType=TIMESTAMP}, #{sortOrder,jdbcType=INTEGER}, ",
    ...
    @Select({
        "select",
        "id, song_id, pass_score, level_id, start_time, end_time, sort_order, status, ",
