...
public interface StageSongMapper {
    ...
    @Insert({
        ...
        "pass_score, start_time, ",
        "end_time, sort_order, ",
        "status, create_time, ",
        "update_time)",
        "values (#{songId,jdbcType=INTEGER}, #{stageLevelId,jdbcType=INTEGER}, ",
        "#{passScore,jdbcType=INTEGER}, #{startTime,jdbcType=TIMESTAMP}, ",
    ...
    @Select({
        "select",
        "id, song_id, stage_level_id, pass_score, start_time, end_time, sort_order, status, ",
