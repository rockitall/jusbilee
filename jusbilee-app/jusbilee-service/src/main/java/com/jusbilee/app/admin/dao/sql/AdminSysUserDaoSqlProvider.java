 ...
 */
public class AdminSysUserDaoSqlProvider {

	public String insertAdmin(AdminSysUser sysUser) {
		// todo
		// 密码格式还没确定
		return new SQL() {
			{
	...
	public String count(AdminSysUserCriteria criteria) {
	...
	public String queryList(AdminSysUserCriteria criteria) {
		StringBuilder sb = new StringBuilder(512);
