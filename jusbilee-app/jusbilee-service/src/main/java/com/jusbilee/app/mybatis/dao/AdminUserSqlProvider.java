...
import com.jusbilee.app.mybatis.pojo.AdminUserCriteria.Criteria;
import com.jusbilee.app.mybatis.pojo.AdminUserCriteria.Criterion;
...
public class AdminUserSqlProvider {
    ...
    public String countByExample(AdminUserCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_admin_user");
     ...
     * @mbg.generated Sat Sep 10 23:20:28 CST 2016
     */
    protected void applyWhere(SQL sql, AdminUserCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
