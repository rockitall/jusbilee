...
import com.jusbilee.app.mybatis.pojo.PassportCriteria.Criteria;
import com.jusbilee.app.mybatis.pojo.PassportCriteria.Criterion;
...
public class PassportSqlProvider {
     ...
     */
    public String countByExample(PassportCriteria example) {
        SQL sql = new SQL();
        sql.SELECT("count(*)").FROM("t_passport");
     ...
     * @mbg.generated Sat Sep 10 23:20:28 CST 2016
     */
    public String deleteByExample(PassportCriteria example) {
        SQL sql = new SQL();
        sql.DELETE_FROM("t_passport");
        applyWhere(sql, example, false);
        return sql.toString();
    }
     ...
     * @mbg.generated Sat Sep 10 23:20:28 CST 2016
     */
    public String selectByExample(PassportCriteria example) {
        SQL sql = new SQL();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        PassportCriteria example = (PassportCriteria) parameter.get("example");
     ...
     * @mbg.generated Sat Sep 10 23:20:28 CST 2016
     */
    protected void applyWhere(SQL sql, PassportCriteria example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
