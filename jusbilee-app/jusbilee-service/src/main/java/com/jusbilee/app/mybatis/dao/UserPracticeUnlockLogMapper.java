...
public interface UserPracticeUnlockLogMapper {
    ...
    @Insert({
        ...
        "is_need_lock, gold_coin, ",
        "is_deleted, create_time, ",
        "update_time)",
        "values (#{userId,jdbcType=BIGINT}, #{practiceSongId,jdbcType=INTEGER}, ",
        "#{isNeedLock,jdbcType=INTEGER}, #{goldCoin,jdbcType=INTEGER}, ",
    ...
    @Results({
        ...
        @Result(column="is_need_lock", property="isNeedLock", jdbcType=JdbcType.INTEGER),
    ...
    @Select({
        "select",
        "id, user_id, practice_song_id, is_need_lock, gold_coin, is_deleted, create_time, ",
        "update_time",
    ...
    @Update({
        ...
        "set user_id = #{userId,jdbcType=BIGINT},",
          ...
          "is_need_lock = #{isNeedLock,jdbcType=INTEGER},",
